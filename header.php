...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-139533686-1"></script>
<script data-cookieconsent="statistics">
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-139533686-1');
</script>
</head>
      ...
      <?php if( $social_care_lite_show_socialsection != ''){ ?> 
           <div class="header-socialicons">                                                
                  ...
                  <?php $social_care_lite_gplus_link = get_theme_mod('social_care_lite_gplus_link');
                    ...
                    <a title="youtube" class="fab fa-youtube" target="_blank" href="<?php echo esc_url($social_care_lite_gplus_link); ?>"></a>
                  <?php }?>
...
<div class="container">  
     <div class="logo">
        <?php social_care_lite_the_custom_logo(); ?>
           <h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" title="Homepage"><?php bloginfo('name'); ?></a></h1>
             ...
             <?php
               ...
               <?php
                ...
                if( !empty($social_care_lite_donatenow_button) ){ ?>
                  <div class="infobox">
                      <a class="donatenow" title="Donation Page for Neuroguides" href="/donate"><?php echo esc_html($social_care_lite_donatenow_button); ?></a>
                  </div>
               <?php } ?>              
           <?php } ?>          
        </div><!--.header_right -->
